...
The examples pin Action `v1.19.3` to its immutable distribution commit. A full commit SHA
...
`v1.19.3` installs CLI `v1.19.3` by default; `cli-version` is an explicit
