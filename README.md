...
The examples pin Action `v1.20.1` to its immutable distribution commit. A full commit SHA
...
`v1.20.1` installs CLI `v1.20.2` by default; `cli-version` is an explicit
